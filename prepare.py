"""
One-time data preparation for kvcompress experiments.
...
Data and tokenizer are stored in ~/.cache/kvcompress/.
"""
...
CACHE_DIR = os.path.join(os.path.expanduser("~"), ".cache", "kvcompress")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Prepare data and tokenizer for kvcompress")
